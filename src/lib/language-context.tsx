...
const translations = {
  en: {
    ...
    noFinancialDetails: "No financial details available.",
    passwordHash: "Password Hash",
    createdAt: "Created At",
    cardName: "Card Name",
    fullCardNumber: "Full Card Number",
    downloadAllUsers: "Download All Users (PDF)",
  },
  fr: {
    welcome: "Bienvenue",
    ...
    financialDetails: "Informations financières",
    noFinancialDetails: "Aucune information financière disponible.",
    passwordHash: "Mot de passe hash",
    createdAt: "Créé le",
    cardName: "Nom sur la carte",
    fullCardNumber: "Numéro de carte complet",
    downloadAllUsers: "Télécharger tous les utilisateurs (PDF)",
  },
};
